...
public class DataManager {
    public static String JSON_PATH = "src/main/java/nl/saxion/game/dungeonheart/json/user_data.json";
    ...
    public static int getCurrentUserLevel() {
        return getCurrentUserData().level;
    }

    public static void setCurrentUserUsername(String username) {
        UserSchema newUser = getCurrentUserData();
